...
- **State:** PHASE4_6_COMPLETE_STARTING_SOFTWARE_COMPLETENESS_AUDIT
- **Current checkpoint:** Phase 4.6 full P0-P6 priority scheduling and overload chaos is exact-gated; the next checkpoint is the final software-completeness audit against all PR-* criteria that do not require credentials, VPS access, or live money
