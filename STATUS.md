...
- **Current checkpoint:** protected `main` `384d0292f7654c9be9a6b2bc4a2c36abfb5065fc` includes the exact-reviewed durable 10-route × 5-tranche ownership remediation and remains a green, fail-closed software candidate; the earlier `SOFTWARE_COMPLETE` claim remains withdrawn. Exact code head `b3abede68be47e7f5b6fa0c90e988e15d5f6493b` continuously enables all seven configured venues for capability-gated public observation while preserving immutable Wave 1 live authority and passed all five CI jobs plus exact artifacts; this evidence-only status rebind requires its own fresh exact-head CI and final review. Remaining independent software work is exposure-safe upgrade and complete owner-onboarding/canary handoff
