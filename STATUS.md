...
- **State:** SOFTWARE_COMPLETE_WAITING_OWNER_ONBOARDING
- **Current checkpoint:** protected `main` `8436cf4e6645aee150c2194b348c3ef9f4d25ac4` contains the complete software-only product plus the merged native Windows preflight and public-feed hardening. Post-merge run `32519959833` passed all five jobs; nonexpired exact artifacts are operations `9460282144`, replay `9460233383`, C4 critical `9460201015`, C4.3 `9460200184`, and security `9460189174`. Annotated prerelease [`v1.0.0-rc2`](https://github.com/brullik/interexchange-perp-grid/releases/tag/v1.0.0-rc2) remains the earlier software-complete release target; the newer laptop workflow is software-only and has not produced credentials, a real 24-hour qualification, orders, eight-hour operation, VPS deployment, or profitability evidence. Live and canary remain fail closed.
