...
- **State:** PHASE3_1_EXACT_65C6_P1_REMEDIATION_LOCAL_GATE
- **Current checkpoint:** Draft PR #5 exact head `65c618f` passed all five GitHub jobs but failed independent lifecycle review because selected-route funding/L2 could outlive shutdown and cancellation during partial-factory rollback could lose ownership; active public scans and rollback closers are now retained under the same bounded shutdown contract locally, with the complete Windows-equivalent gate green pending a new exact head
