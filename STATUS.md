...
- **State:** AGGRESSIVE_SYMBIOSIS_V1 / A2_LOCAL_PASS / A3_NEXT / LIVE_DISABLED
- **Current checkpoint:** actual `origin/main` is `8ef3ad3dbf746917a5fa6cb46f366634ea5747f9`; the owner-supplied Aggressive Symbiosis V1 package verified 8/8 SHA-256 entries and is installed in Draft PR #22 on the single branch `codex/aggressive-symbiosis-v1`. The prior adaptive-only laptop qualification was explicitly stopped and is not accepted for this strategy. A1 checkpoint `3256553` passed local lock64/Ruff122/mypy122/pytest732+16 skips/doctor and exact run `32787080043` passed all five jobs. A1 provides typed closed source-minute and canonical reference-spread bars, deterministic Decimal log-ratio OHLC, explicit quality/version rejection, no forward-fill, atomic Parquet/DuckDB replay and public non-submit proof. A2 now adds locked-profile 180d/90d/30d coverage gates, exact modal `S0` tie-breaks and q10 normal zone, separate positive/negative extremes, five 20/40/60/80/100% levels with 10/15/20/25/30% weights and +15% stops, normal-reset convergence episodes with per-level timing/adverse/censoring, 10-episode/70% gate, complete 24h/7d/30d robust windows, directional drift block, active-route freeze, 20%/day updates, strict atomic restart artifacts, and exact source/reference/profile/code/route/contract identity. The A2 tree passed lock64, Ruff124, strict mypy124, pytest747 passed/16 platform skips, and doctor `shadow/live_orders_allowed=false`; its CLI proof remains public-data-only with `production_submit_calls=0`. No live authority, VPS action, or new qualification is claimed.
